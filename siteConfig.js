export default {
  ...
  section: {
    ...
    second: {
      ...
      video:
        'https://super-dashboard-images-cdn.s3.amazonaws.com/videos/How-to-use-Netflix-Party-final-2.mp4',
      accordian: [
        {
          id: 1,
          question: 'INSTALL THE EXTENSION',
          answer:
            'The first step is to download the Netflix party extension <a href="https://chrome.google.com/webstore/detail/netflix-party/djpbcgbfllffgmoedmonmjbaofikcnnc" target="_blank" rel="noopener"><u>Click here</u></a> to install the free, user-friendly extension. Moreover, please make sure that you have either Google Chrome or Microsoft Edge browser to install it. Furthermore, the extension is compatible with Chromebooks, macOS, Laptops, Windows, and Computers.',
        },

        {
          id: 2,
          question: 'PIN THE EXTENSION',
          answer:
        ...
        {
          id: 5,
          question: 'CREATE THE NETFLIX WATCH PATRY',
          answer:
